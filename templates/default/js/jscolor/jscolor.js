...
var jscolor = {
	...
	color : function(target, prop) {
		...
		function removePicker() {
			...
			jscolor.picker.box.removeEventListener('touchmove', this.handleTouchMove, false);
		...
		function drawPicker(x, y) {
			...
			if('ontouchstart' in window) { // if touch device
				...
				this.handleTouchMove = handle_touchmove;
			}
			p.padM.onmouseup =
		...
		// target
		jscolor.addEvent(target, 'focus', function(e) {
			if(THIS.pickerOnfocus) {
				THIS.showPicker();
				e.preventDefault();
				e.stopPropagation();
